...
export const metadata: Metadata = {
  ...
  keywords: [
    "home care services in Coimbatore",
    "home nursing services in Coimbatore",
    "elderly care services in Coimbatore",
    "patient care taker in Coimbatore",
    "caregiver services in Coimbatore",
    "24 hours nursing care at home Coimbatore",
    "postnatal baby care in Coimbatore",
    "physiotherapy home visit Coimbatore",
    "doctor home visit Coimbatore",
    "female patient caretaker Coimbatore"
  ],
